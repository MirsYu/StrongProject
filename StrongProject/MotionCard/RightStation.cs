...
{	/// <summary>
	...
	public short Step4(object o)
	{
        while (true)
        {
            if (tag_Work.tag_workObjectManage.tag_LeftStation.tag_isWork == 0)
            {
                Thread.Sleep(300);
	...
	public short Init()
	{
		...
		PointAggregate _Step4 = pointMotion.FindPoint(tag_stationName, "激光开始",4);
		if (_Step4  == null)
		{
			return -1;
		}
		_Step4 .tag_BeginFun = Step4 ;
		PointAggregate _Step5 = pointMotion.FindPoint(tag_stationName, "激光第一个点位",5);
		if (_Step5  == null)
		{
			return -1;
		}
		_Step5 .tag_BeginFun = Step5 ;
		PointAggregate _Step6 = pointMotion.FindPoint(tag_stationName, "激光第一个焊接",6);
		if (_Step6  == null)
		{
			return -1;
		}
		_Step6 .tag_BeginFun = Step6 ;
		PointAggregate _Step7 = pointMotion.FindPoint(tag_stationName, "激光第二个点位",7);
		if (_Step7  == null)
		{
			return -1;
		}
		_Step7 .tag_BeginFun = Step7 ;
		PointAggregate _Step8 = pointMotion.FindPoint(tag_stationName, "激光第二个焊接",8);
		if (_Step8  == null)
		{
			return -1;
		}
		_Step8 .tag_BeginFun = Step8 ;
		PointAggregate _Step9 = pointMotion.FindPoint(tag_stationName, "激光第三个点位",9);
		if (_Step9  == null)
		{
			return -1;
		}
		_Step9 .tag_BeginFun = Step9 ;
		PointAggregate _Step10 = pointMotion.FindPoint(tag_stationName, "激光第三个焊接",10);
		if (_Step10  == null)
		{
			return -1;
		}
		_Step10 .tag_BeginFun = Step10 ;
		PointAggregate _Step11 = pointMotion.FindPoint(tag_stationName, "激光第四个点位",11);
		if (_Step11  == null)
		{
			return -1;
		}
		_Step11 .tag_BeginFun = Step11 ;
		PointAggregate _Step12 = pointMotion.FindPoint(tag_stationName, "激光第四个焊接",12);
		if (_Step12  == null)
		{
			return -1;
		}
		_Step12 .tag_BeginFun = Step12 ;
		PointAggregate _Step13 = pointMotion.FindPoint(tag_stationName, "激光第五个点位",13);
		if (_Step13  == null)
		{
			return -1;
		}
		_Step13 .tag_BeginFun = Step13 ;
		PointAggregate _Step14 = pointMotion.FindPoint(tag_stationName, "激光第五个焊接",14);
		if (_Step14  == null)
		{
			return -1;
		}
		_Step14 .tag_BeginFun = Step14 ;
		PointAggregate _Step15 = pointMotion.FindPoint(tag_stationName, "激光第六个点位",15);
		if (_Step15  == null)
		{
			return -1;
		}
		_Step15 .tag_BeginFun = Step15 ;
		PointAggregate _Step16 = pointMotion.FindPoint(tag_stationName, "激光第六个焊接",16);
		if (_Step16  == null)
		{
			return -1;
		}
		_Step16 .tag_BeginFun = Step16 ;
		PointAggregate _Step17 = pointMotion.FindPoint(tag_stationName, "激光第七个点位",17);
		if (_Step17  == null)
		{
			return -1;
		}
		_Step17 .tag_BeginFun = Step17 ;
		PointAggregate _Step18 = pointMotion.FindPoint(tag_stationName, "激光第七个焊接",18);
		if (_Step18  == null)
		{
			return -1;
		}
		_Step18 .tag_BeginFun = Step18 ;
		PointAggregate _Step19 = pointMotion.FindPoint(tag_stationName, "激光第八个点位",19);
		if (_Step19  == null)
		{
			return -1;
		}
		_Step19 .tag_BeginFun = Step19 ;
		PointAggregate _Step20 = pointMotion.FindPoint(tag_stationName, "激光第八个焊接",20);
		if (_Step20  == null)
		{
			return -1;
		}
		_Step20 .tag_BeginFun = Step20 ;
		PointAggregate _Step21 = pointMotion.FindPoint(tag_stationName, "Y1轴运动到下料点位",21);
		if (_Step21  == null)
		{
			return -1;
		}
		_Step21 .tag_BeginFun = Step21 ;
		PointAggregate _Step22 = pointMotion.FindPoint(tag_stationName, "伸出气缸复位",22);
		if (_Step22  == null)
		{
			return -1;
		}
		_Step22 .tag_BeginFun = Step22 ;
		PointAggregate _Step23 = pointMotion.FindPoint(tag_stationName, "顶升气缸复位",23);
		if (_Step23  == null)
		{
			return -1;
		}
