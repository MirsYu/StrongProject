...
namespace StrongProject
{
    ...
    //    public const double accTime = 0.1;  //加减速时间
        ...
        public static short SR_GetEncPos(short card, short axis, ref double[] pos, int count = intAxisCountForCard)
        {
            ...
            {
                shrResult = (short)adt8940a1m.adt8940a1_get_actual_pos(card, (short)i, out posV);
        ...
        public static short SR_InitCard(short card, short axisCount, string configFileName = null)
        {
            ...
            for (Int32 i = 1; i < intAxisCountForCard + 1; i++)
                ...
                {
                    adt8940a1m.adt8940a1_set_limit_mode(j, i, 0, 0, 1); //设定限位模式，设正负限位有效，低电平有效
        ...
        private static short PubReadInput(short card, short startId,short count,short step,ref int value)
        {
            ...
            {
                shrReadId = (short)(startId + i * step);
        ...
        public static short SR_GetInputBit(short card, short ioBit, out bool bStatus)
        {
            ...
            if (card >= 11)
            {
                shrResult = (short)adtIO3224.adtIO3224_read_in((int)(card - intExtendStartId), out  iioBit);
        ...
        public static short SR_GetInput(short card, out ulong pValue)
        {
            ...
            {
                shrResult = ExtendIoCard.GetIpnutIoAll((short)(card - intExtendStartId), out pValue);
                if (shrResult != shrGtsSuccess)
                {
                    return shrFail;
                }
            ...
            {
                for (short i = 15; i < intInputIoCount; i++)
                {
        ...
        public static short SR_GoHome(AxisConfig _acf,  short card, short axis, double hightSpeed, double lowSpeed, int dir, int m_nBackRange)
        {
            short shrResult;
            int m_nStop0Active = 0;

            if(_acf.tag_homeIoHighLow)
            {
                m_nStop0Active = 1;
            }

            shrResult = (short)adt8940a1m.adt8940a1_SetHomeMode_Ex(card, axis, dir, m_nStop0Active, 1, -1, m_nBackRange, 1, 0);
            if (shrResult != shrGtsSuccess)
            {
                CommandResult("adt8940a1_SetHomeMode_Ex", shrResult);
                return shrFail;
            }
            shrResult = (short)adt8940a1m.adt8940a1_SetHomeSpeed_Ex(card, axis, (int)_acf.StartSpeed, (int)(hightSpeed * 1000), (int)(lowSpeed * 1000), (int)_acf.Acc,  (int)(lowSpeed * 1000));
            if (shrResult != shrGtsSuccess)
            {
        ...
        /// <param name="dir">回原方向 0正方向回原  非0 负方向</param>
        /// <returns>返回0表示回原成功，非0轴回原失败或函数异常</returns>
        public static short SR_GoHome(AxisConfig axisC, short card, short axis, double hightSpeed, double lowSpeed, int dir)
        {
            return SR_GoHome(axisC,card, axis, hightSpeed, lowSpeed, dir, (int)axisC.intFirstFindOriginDis);
        }
        /// <summary>
        /// 步进回原函数
        /// </summary>
        ...
        /// <param name="dir">回原方向 0正方向回原  非0 负方向</param>
        /// <returns>返回0表示回原成功，非0轴回原失败或函数异常</returns>
        public static short SR_GoHomeWithStepMotor(AxisConfig axisC, short card, short axis, double hightSpeed, double lowSpeed, int dir, int m)
        {            
            short shrResult;
            shrResult = SR_GoHome(axisC,card, axis, hightSpeed, lowSpeed, dir, m);
            if (shrResult != shrSuccess)
            {
                return shrFail;
            }            
        ...
        /// <returns></returns>
        public static short SR_RelativeMove(AxisConfig axisC, short card, short axis, int postion, double speed)
        {
            short shrResult = 0;
            if (speed == 0)
            {
            ...
            shrResult = (short)adt8940a1m.adt8940a1_symmetry_relative_move(card, axis, postion, (int)axisC.StartSpeed,(int)(speed * 1000), axisC.tag_accTime);
            if (shrResult != shrGtsSuccess)
            {
        ...
        /// <param name="speed">速度</param>
        /// <returns></returns>
        public static short SR_AbsoluteMove(AxisConfig axisC, short card, short axis, int postion, double speed)
        {
            short shrResult = 0;
            if (speed == 0)
            {
            ...
            shrResult = (short)adt8940a1m.adt8940a1_symmetry_absolute_move(card, axis, postion, (int)axisC.StartSpeed, (int)(speed * 1000), axisC.tag_accTime);
            if (shrResult != shrGtsSuccess)
            {
        ...
        /// <returns></returns>
        public static short SR_ContinueMove(AxisConfig axisC, short card, short axis, double speed, short dir = 0)
        {
            short shrResult = 0;


            shrResult = (short)adt8940a1m.adt8940a1_set_startv(0, axis, (int)axisC.StartSpeed); // 300000
            if (shrResult != shrGtsSuccess)
            {
        ...
        public static short GoHome(string stationName, string axisName)
        {
            ...
            short shrResult = SR_GoHome(axisC,axisC.CardNum, axisC.AxisNum, axisC.HomeSpeedHight * axisC.Eucf / 1000, axisC.HomeSpeed * axisC.Eucf / 1000, (int)axisC.HomeDir, (int)axisC.intFirstFindOriginDis);
            if (shrResult != shrSuccess)
            {
                return shrFail;
            }
        ...
        public static short GoHomeWithStepMotor(string stationName, string axisName)
        {
            ...
            short shrResult = SR_GoHomeWithStepMotor(axisC,axisC.CardNum, axisC.AxisNum, axisC.HomeSpeedHight * axisC.Eucf / 1000, axisC.HomeSpeed * axisC.Eucf / 1000, (int)axisC.HomeDir, (int)axisC.intFirstFindOriginDis);
            if (shrResult != shrSuccess)
            {
                return shrFail;
            }
        ...
        public static short GoHomeForThread(string stationName, string axisName)
        {
            ...
            Thread homeThread = new Thread(new ParameterizedThreadStart(delegate { SR_GoHome(axisC,axisC.CardNum, axisC.AxisNum, axisC.HomeSpeedHight * axisC.Eucf / 1000, axisC.HomeSpeed * axisC.Eucf / 1000, (int)axisC.HomeDir, (int)axisC.intFirstFindOriginDis); }));
            homeThread.Start();
        ...
        public static short AxisAbsoluteMove(string stationName, string axisName, string pointName)
        {
            ...
            short shrResult = SR_AbsoluteMove(axisC, axisC.CardNum, axisC.AxisNum, (int)(pointA.arrPoint[axisC.AxisIndex].dblPonitValue * axisC.Eucf), pointA.arrPoint[axisC.AxisIndex].dblPonitSpeed * axisC.Eucf / 1000);
            if (shrResult != shrSuccess)
            {
                return shrFail;
            }
        ...
        public static short AxisJoMove(string stationName, string axisName)
        {
            ...
            {
                shrResult = SR_ContinueMove(axisC,axisC.CardNum, axisC.AxisNum, (int)(axisC.Speed * axisC.Eucf / 1000), axisC.JogDir);
                if (shrResult != shrSuccess)
                {
                    return shrFail;
                }
        ...
        public static short AxisAbsoluteMove(string stationName, string axisName, string pointName, int asxisIndex)
        {
            ...
            {
                 shrResult = SR_AbsoluteMove(axisC, axisC.CardNum, axisC.AxisNum, (int)(pointA.arrPoint[asxisIndex].dblPonitValue * axisC.Eucf), pointA.arrPoint[asxisIndex].dblPonitSpeed * axisC.Eucf / 1000);
            }
            else
            {
                shrResult = SR_RelativeMove(axisC, axisC.CardNum, axisC.AxisNum, (int)(pointA.arrPoint[asxisIndex].dblPonitValue * axisC.Eucf), pointA.arrPoint[asxisIndex].dblPonitSpeed * axisC.Eucf / 1000);
        ...
        public static short AxisRelativeMove(string stationName, string axisName, string pointName)
        {
            ...
            shrResult = SR_RelativeMove(axisC,axisC.CardNum, axisC.AxisNum, (int)(pointA.arrPoint[axisC.AxisIndex].dblPonitValue * axisC.Eucf), pointA.arrPoint[axisC.AxisIndex].dblPonitSpeed * axisC.Eucf / 1000);
            if (shrResult != shrSuccess)
            {
                return shrFail;
            }
        ...
        public static short AxisRelativeMoveAndVrfStop(string stationName, string axisName, double offValue, double speed)
        {
            ...
            shrResult = SR_RelativeMove(axisC,axisC.CardNum, axisC.AxisNum, (int)(offValue * axisC.Eucf), speed * axisC.Eucf / 1000);
            if (shrResult != shrSuccess)
            {
                return shrFail;
            }
        ...
        /// <summary>
        /// 伺服电机绝对运动并等待轴停止，检测运动结果 用于相机补正后点位
        /// </summary>
        /// <param name="stationName"></param>
        /// <param name="axisName"></param>
        /// <param name="pointName"></param>
        /// <returns></returns>
        public static short AxisAbsoluteMoveAndVrfStop_Camera(string stationName, string axisName, double offValue, double speed)
        {
            double dblPos = 0;
            uint pClock = 0;
            short shrResult=0;
            ...
            {
                dblPos = dblPos / axisC.Eucf;
                if ( offValue > axisC.SoftLimitMaxValue)
                {
                    CFile.WriteErrorForDate(axisC.CardNum + "卡" + axisC.AxisNum + "轴" + "运动去点 " + (offValue).ToString() + "  大于该轴软正限位");
                    return shrFail2;
                }
                if ( offValue < axisC.SoftLimitMinValue)
                {
                    CFile.WriteErrorForDate(axisC.CardNum + "卡" + axisC.AxisNum + "轴" + "运动去点 " + (offValue).ToString() + "  小于该轴软负限位");
                    return shrFail2;
                }
            }
            shrResult = SR_AbsoluteMove(axisC, axisC.CardNum, axisC.AxisNum, (int)(offValue * axisC.Eucf), speed * axisC.Eucf / 1000);
            if (shrResult != shrSuccess)
            {
                return shrFail;
            }
            ...
            shrResult = VerificationAxisPoint(axisC.CardNum, axisC.AxisNum, (int)(offValue * axisC.Eucf));
            if (shrResult != shrSuccess)
            {
                return shrFail;
            }
        ...
        /// <summary>
        /// 伺服电机绝对运动不等待轴停止，检测运动结果 用于相机补正后点位
        /// </summary>
        /// <param name="stationName"></param>
        /// <param name="axisName"></param>
        /// <param name="pointName"></param>
        /// <returns></returns>
        public static short AxisAbsoluteMoveAndVrf_Camera(string stationName, string axisName, double offValue, double speed)
        {
            double dblPos = 0;
            uint pClock = 0;
            short shrResult = 0;
        ...
        public static short AxisJoMoveForSignalStop(string stationName, string axisName, string inputName, bool check, short dir = 0, double outTime = 10)
        {
            ...
            if (SR_IsAxisStop(axisC.CardNum, axisC.AxisNum) == shrSuccess)
            {
                shrResult = SR_ContinueMove(axisC, axisC.CardNum, axisC.AxisNum, (axisC.Speed * axisC.Eucf / 1000), dir);
                if (shrResult != shrSuccess)
                {
                    return shrFail;
                }
        ...
        /// 判断是否右轴报警 TRUE 报警
        /// </summary>
        public static bool IsAxisAlarm()
        {
            foreach (int i in arraAxisAlarmStatus)
            {
                if(i != 0)
                    return true;
            }
        ...
        /// 判断是否右轴报警 TRUE 报警
        /// </summary>
        public static bool IsAxisLimitAlarm()
        {
            foreach (int i in arrAxisLimitPStatus)
            {
                if (i != 0)
                    return true;
            }
            foreach (int i in arrAxisLimitNStatus)
            {
                if (i != 0)
                    return true;
            }
